...
public interface ProductCompositeService {
	...
	/*
	 * Improving Resilience: Add programmable delays and errors
	 *	 
	 */
	...
	Mono<ProductAggregate> getProduct(@PathVariable int productId, @RequestParam(value = "delay", required = false, defaultValue = "0") int delay, 
